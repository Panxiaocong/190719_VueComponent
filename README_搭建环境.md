...
## 4. 打包处理 ES6/CSS/图片
    ...
    1). 处理ES6
        a. 下载依赖包
            yarn/npm add -D babel-loader @babel/core @babel/preset-env
        b. 配置
            {
              test: /\.js$/,
    ...
    2). 处理CSS
        a. 下载依赖包
            yarn/npm install --save-dev css-loader
        b. 配置
            {
              test: /\.css$/,
    ...
    3). 处理图片
        a. 下载依赖包
            yarn/npm add -D url-loader@2.3.0 file-loader@4.3.0
        b. 配置
            {
...
## 5. 搭建 vue 的环境
    ...
    1). 下载依赖包:
        yarn/npm add vue
        yarn/npm add -D vue-loader vue-template-compiler
